...
export const config = {
  dataUrl: "/data/aircraft-thermoformed-sheets-market.json",
  title: "Aircraft Interior Thermoformed Sheets Market",
  subtitle: "Global Market Research Dashboard",
  defaultYear: 2025, useMillions: true,
  footerText: "Aircraft Interior Thermoformed Sheets Market Research Report",
