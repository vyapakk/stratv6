import { BarChart3, Plane, Globe, Users, Package, Wrench, UtensilsCrossed } from "lucide-react";
...
export const config = {
  dataUrl: "/data/aircraft-galley-market.json",
  title: "Aircraft Galley Market",
