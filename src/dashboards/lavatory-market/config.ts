import { BarChart3, Plane, Globe, Users, Package, Bath } from "lucide-react";
...
export const config = {
  dataUrl: "/data/aircraft-lavatory-market.json",
  title: "Aircraft Lavatory Market",
  ...
  tabs: [
    ...
    { id: "application", label: "Lavatory Type", icon: Bath },
