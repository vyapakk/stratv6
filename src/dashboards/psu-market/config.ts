import { BarChart3, Plane, Globe, Users, Package, Wrench } from "lucide-react";
...
export const config = {
  dataUrl: "/data/aircraft-psu-market.json",
  title: "Aircraft PSU Market",
  subtitle: "Global Market Research Dashboard",
  defaultYear: 2025,
  useMillions: true,
  footerText: "Aircraft PSU Market Research Report",
  ...
  tabs: [
    ...
    { id: "application", label: "Equipment Type", icon: Package },
    { id: "equipment", label: "Component Type", icon: Wrench },
  ] as TabConfig[],
  labels: {
  ...
  segmentMapping: {
    ...
    application: { dataKey: "application",        title: "Equipment Type" },
    equipment:   { dataKey: "furnishedEquipment", title: "Component Type" },
