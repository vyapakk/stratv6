...
export const config = {
  dataUrl: "/data/aircraft-floor-panels-market.json",
  title: "Aircraft Floor Panels Market",
  ...
  labels: { endUser: "End-User Type", equipment: "Equipment Type", application: "Core Type", processType: "Process Type", materialType: "Material Type" },
  segmentMapping: {
